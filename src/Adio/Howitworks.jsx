        ...
        <section className="lifelink-Howitworks-first-section">
          <div className="lifelink-text">
            ...
            <p>
              ...
              blood, SOLDAT streamlines the process for you. <br />
          ...
          <section className="hospital-steps">
            ...
            <div className="steps-container">
              <div className="step-boxes step-1">
                ...
                <p>Locate a nearby hospital or blood bank using SOLDAT</p>
              </div>
        ...
        <section className="hospital-steps-cnt">
          ...
          <div className="steps-container">
            <div className="step-boxes step-1">
              ...
              <p>Sign up on SOLDAT & get verified as a trusted hospital or blood bank.</p>
            </div>
            ...
            <div className="step-boxes step-3">
              ...
              <p>Accept donors who visit with their unique SOLDAT codes & confirm their donations.</p>
            </div>
